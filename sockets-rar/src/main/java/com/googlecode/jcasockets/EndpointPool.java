...
public class EndpointPool implements WorkListener {
    ...
    public EndpointPool(MessageEndpointFactory endpointFactory, int maxEndpoints, long timeout,
            TimeUnit timeUnit) {
    ...
    private void allocateEndPoint(SocketMessageEndpoint messageEndpoint)
